...
namespace Battery.Repository.Migrations
{
    ...
    [Migration("20231128181100_initialmonster1")]
    partial class initialmonster1
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Battery.Entities.Concrete.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2023, 11, 28, 21, 11, 0, 209, DateTimeKind.Local).AddTicks(6836),
                            UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2023, 11, 28, 21, 11, 0, 209, DateTimeKind.Local).AddTicks(6849),
                            UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2023, 11, 28, 21, 11, 0, 209, DateTimeKind.Local).AddTicks(6850),
                            UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2023, 11, 28, 21, 11, 0, 209, DateTimeKind.Local).AddTicks(6851),
                            UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2023, 11, 28, 21, 11, 0, 209, DateTimeKind.Local).AddTicks(6853),
                            UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        });
                });
